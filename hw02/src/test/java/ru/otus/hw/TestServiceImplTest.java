...
class TestServiceImplTest {
    ...
    private DummyIOService ioService;
    private DummyQuestionDao questionDao;
    private TestServiceImpl testService;

    @BeforeEach
    void setUp() {
        ioService = new DummyIOService();
    ...
    void shouldPrintWelcomeMessageBeforeTest() {
        ...
        assertThat(ioService.getMessages())
    ...
    void shouldPrintEmptyLineAtStart() {
        ...
        assertThat(ioService.getMessages()).contains("");
    }
